...
export class BashFile implements BaseBashFile {
  ...
  public static async parse({
    ...
    try {
      fileNode = await parse(contents)
    } catch (e) {
      console.log('failed parsing', uri, e)
    }
